...
class OtherMarket extends StatefulWidget {
  const OtherMarket({Key? key}) : super(key: key);

  @override
  _OtherMarketState createState() => _OtherMarketState();
}

class _OtherMarketState extends State<OtherMarket> {
  TextEditingController searchController = TextEditingController();
  String query = '';
  String searchOption = '';
  String location = '';
  String productsType = 'Other';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const BoldText(
            text: "Other products", size: 20, color: Colors.white),
        elevation: 0,
      ),
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Search tools, pesticides,etc',
                    ...
                    child: market.dataLoaded
                        ? GridView.extent(
                            ...
                            children: searching == false
                                ? List.generate(otherproducts.length, (index) {
                                      ...
                                      child: Column(children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              AppText(
                                                  text: otherproducts[index]
                                                              .title
                                                              .length >
                                                          7
                                                      ? "${otherproducts[index].title.substring(0, 7)} ..."
                                                      : otherproducts[index]
                                                          .title,
                                                  size: 16,
                                                  bold: true),
  ...
  _filterProducts(String title) {
    results.clear();
    if (title.isNotEmpty) {
      for (var element in otherproducts) {
